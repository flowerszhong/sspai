webpackJsonp([12], {
    ...
    /***/
        ...
        (function($) {
            ...
            // 寮曞叆鐩稿叧js鏂囦欢瀵逛簬Matrix鎿嶄綔  byDennis
            var index = new _index2['default']();
            var limit = 3;
            var url = $('.pages .pager li').last().find('a').attr('href');
            var nextPage = Number(index.getParameterByName(url, 'page'));
            var indexSwiper;

            // 鏂囩珷鏁伴噺灏戜簬涓夌瘒涓嶆樉绀哄垎椤�  byDennis
            if (nextPage <= limit) {
                $('.loading').removeClass('hidden');
                $('.pages').addClass('hidden');
                index.loadMoreArtile(limit);
            }
            // 鍘婚櫎榛樿浜嬩欢鐨勮Е鍙�  byDennis
            $('.widget-matrix-newest').on('click', '.item .author', function(e) {
                e.stopPropagation();
                e.preventDefault();
            });
            // js濯掍綋鏌ヨ  byDennis
            _enquire2['default'].register("screen and (min-width: " + _screen_variable.screen_all_min + "px) and (max-width: " + _screen_variable.screen_xs_max + "px)", {
                ...
                match: function match() {
                    indexSwiper = index.initSwiperMobile();
                }
            });
            ...
            _enquire2['default'].register("screen and (min-width: " + _screen_variable.screen_md_min + "px) and (max-width: " + _screen_variable.screen_md_max + "px)", {
                ...
                match: function match() {
                    indexSwiper = index.initSwiperDesktop(indexSwiper);
                }
            });
            /* WEBPACK VAR INJECTION */
            ...
            (function() {
                ...
                var Swiper = function Swiper(container, params) {
                    ...
                    var defaults = {
                        ...
                        speed: 300, // autoplay
                        autoplay: false,
                        autoplayDisableOnInteraction: true, // To support iOS's swipe-to-go-back gesture (when being used in-app, with UIWebView).
                        ...
                        freeModeMinimumVelocity: 0.02, // Set wrapper width
                        ...
                        onlyExternal: false,
                        threshold: 0,
                        touchMoveStopPropagation: true, // Pagination
                        pagination: null,
                        paginationElement: 'span',
                        paginationClickable: false,
                        paginationHide: false,
                        paginationBulletRender: null, // Resistance
                        resistance: true,
                        ...
                        paginationHiddenClass: 'swiper-pagination-hidden', // Observer
                        observer: false,
                    ...
                    s.updateSlidesSize = function() {
                        ...
                        for (i = 0; i < s.slides.length; i++) {
                            ...
                            if (s.params.slidesPerColumn > 1) { // Set slides order
                    ...
                    s.updateClasses = function() {
                        ...
                        activeSlide.prev('.' + s.params.slideClass).addClass(s.params.slidePrevClass); // Pagination
                    ...
                    var isTouched, isMoved, touchStartTime, isScrolling, currentTranslate, startTranslate, allowThresholdMove, // Form elements to match
                    ...
                    s.onTouchMove = function(e) {
                        ...
                        if (s.params.onlyExternal) { // isMoved = true;
                            s.allowClick = false;
                            if (isTouched) {
                    ...
                    s.getTranslate = function(el, axis) {
                        ...
                        if (axis === 'y') { //Latest Chrome and webkits Fix
                        ...
                        cube: {
                            setTranslate: function setTranslate() {
                                ...
                                for (var i = 0; i < s.slides.length; i++) {
                                    ...
                                    if (s.params.cube.slideShadows) { //Set shadows
                        ...
                        coverflow: {
                            setTranslate: function setTranslate() {
                                ...
                                for (var i = 0, length = s.slides.length; i < length; i++) {
                                    ...
                                    var rotateX = isH() ? 0 : rotate * offsetMultiplier; // var rotateZ = 0
                                    var translateZ = -translate * Math.abs(offsetMultiplier);
                                    var translateY = isH() ? 0 : s.params.coverflow.stretch * offsetMultiplier;
                                    var translateX = isH() ? s.params.coverflow.stretch * offsetMultiplier : 0; //Fix for ultra small values
                                    ...
                                    if (s.params.coverflow.slideShadows) { //Set shadows
                                        var shadowBefore = isH() ? slide.find('.swiper-slide-shadow-left') : slide.find('.swiper-slide-shadow-top');
                                        var shadowAfter = isH() ? slide.find('.swiper-slide-shadow-right') : slide.find('.swiper-slide-shadow-bottom');
                                        if (shadowBefore.length === 0) {
                                            shadowBefore = $('<div class="swiper-slide-shadow-' + (isH() ? 'left' : 'top') + '"></div>');
                    ...
                    s.lazy = {
                        ...
                        load: function load() {
                            ...
                            if (s.params.lazyLoadingInPrevNext) {
                                if (s.params.slidesPerView > 1) { // Next Slides
                    ...
                    s.controller = {
                        ...
                        setTranslate: function setTranslate(translate, byController) {
                            ...
                            function setControlledTranslate(c) { // this will create an Interpolate function based on the snapGrids
                    ...
                    s.off = function(eventName, handler) {
                        var i;
                        eventName = normalizeEventName(eventName);
                        if (typeof handler === 'undefined') { // Remove all handlers for such event
                    ...
                    s.a11y = {
                        ...
                        init: function init() { // Setup accessibility
                            if (s.params.nextButton) {
                ...
                var Dom7 = (function() {
                    ...
                    Dom7.prototype = { // Classes and attriutes
                        ...
                        attr: function attr(attrs, value) {
                            if (arguments.length === 1 && typeof attrs === 'string') { // Get attr
                        ...
                        on: function on(eventName, targetSelector, listener, capture) {
                            ...
                            for (i = 0; i < this.length; i++) {
                                if (typeof targetSelector === 'function' || targetSelector === false) { // Usual events
                        ...
                        transitionEnd: function transitionEnd(callback) {
                            ...
                            function fireCallBack(e) { /*jshint validthis:true */
    ...
    /***/
        ...
        (function($) { // 寮曞叆鎻掍欢  byDennis
            ...
            var _SwiperDistJsSwiper = __webpack_require__(46);

            var _SwiperDistJsSwiper2 = _interopRequireDefault(_SwiperDistJsSwiper);
            ...
            var Index = (function() {
                ...
                _createClass(Index, [{
                    ...
                    // ECMA Script6 瀵煎嚭榛樿 绫�  byDennis
                    // 鑾峰彇鍦板潃  byDennis
                    value: function getParameterByName(url, name) {
                        name = name.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
                        var regex = new RegExp("[\\?&]" + name + "=([^&#]*)"),
                            results = regex.exec(url);
                        // 妫€绱㈠瓧绗︿覆涓殑鎸囧畾url  byDennis
                    ...
                    key: 'loadMoreArtile',
                    value: function loadMoreArtile(limit) {
                        $('.main').on('inview', '.inview', function(event, isInView, visiblePart) {
                            var url = $('.pages .pager li').last().find('a').attr('href');
                            var nextPage = Number(Index.prototype.getParameterByName(url, 'page'));
                            // var currentPage = Number($('.pagination .active').text());
                            if (nextPage <= limit && visiblePart === 'both') {
                                $.ajax({
                                    type: 'get',
                                    url: '/?page=' + nextPage,
                            ...
                            } else if (nextPage > limit) {
                                $('.loading').unbind('inview').addClass('hidden');
                    ...
                    key: 'adjustSwiperHeight',
                    value: function adjustSwiperHeight() {
                        var windowWidth = $(window).width();
                        var swiperHeight = parseInt(windowWidth / 2.5);
                        $('.slider-appstore .swiper-container').height(swiperHeight);
                        // 寮曠敤鍦板潃resources/views/common/slide/appstore.blade.php  byDennis
                    }

                    // PC杞挱鍥惧垵濮嬪寲  byDennis
                }, {
                    key: 'initSwiperDesktop',
                    value: function initSwiperDesktop() {
                        return new _SwiperDistJsSwiper2['default']('.col-full-slide .swiper-container', {
                            autoplay: 5000,
                            speed: 700,
                            loop: true,
                            slidesPerView: 'auto',
                    ...
                    // mobile杞挱鍥惧垵濮嬪寲  byDennis
                }, {
                    key: 'initSwiperMobile',
                    value: function initSwiperMobile(swiper) {
                        swiper = new _SwiperDistJsSwiper2['default']('.col-full-slide .swiper-container', {
                            autoplay: 5000,
                            speed: 700,
                            loop: true
                        });

                        Index.prototype.adjustSwiperHeight();
                        return swiper;
                    }
                }]);
