    ...
    /***/
        ...
        (function(global, factory) {
            ...
            var // Use the correct document accordingly with window argument (sandbox)
                ...
                version = "2.1.4", // Define a local copy of jQuery
            ...
            jQuery.extend({ // Unique for each copy of jQuery on the page
                ...
                isPlainObject: function isPlainObject(obj) { // Not plain objects:
            ...
            var Sizzle =
                ...
                (function(window) {
                    ...
                    function Sizzle(selector, context, results, seed) {
                            ...
                            if (!seed && documentIsHTML) { // Try to shortcut find operations when possible (e.g., not under DocumentFragment)
                    ...
                    setDocument = Sizzle.setDocument = function(node) {
                        ...
                        rbuggyQSA = [];
                        if (support.qsa = rnative.test(doc.querySelectorAll)) { // Build QSA regex
            ...
            Data.prototype = {
                key: function key(owner) { // We can accept data for non-element nodes in modern browsers,
                ...
                get: function get(owner, key) { // Either a valid cache is found, or will be created.
            ...
            jQuery.event = {
                ...
                simulate: function simulate(type, elem, event, bubble) { // Piggyback on a donor event to simulate a different one.
            ...
            jQuery.fn.extend({
                ...
                domManip: function domManip(args, callback) { // Flatten any nested arrays
